...
public class UICenterOnChild : MonoBehaviour
{
    ...
    public delegate bool CenterFilter (GameObject obj);	// 用于决定obj是否可以被选中
    ...
    public CenterFilter centerFilter;
	...
	public void Recenter ()
	{
		...
		for (int i = 0, imax = trans.childCount; i < imax; ++i)
		{
			...
			if (centerFilter != null && centerFilter (t.gameObject)) continue;
