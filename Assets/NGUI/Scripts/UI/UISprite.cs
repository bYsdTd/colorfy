...
public class UISprite : UIBasicSprite
{
	...
	/// </summary>
	[HideInInspector][SerializeField] bool mIsGreyColor = false;

	static Shader greyShader = null;
	...
	public override Shader shader
	{
		get
		{
			if(mIsGreyColor)
			{
				if(greyShader == null)
				{
					greyShader = ShaderManager.Instance().grey_color_shader_;
				}
