...
public class UICamera : MonoBehaviour
{
	...
	static public void Notify (GameObject go, string funcName, object obj)
	{
		...
		#if UNITY_EDITOR
//		if(GUIMgr.kEnablePrintClickUiName)
//		{
//			if(go != null)
//			{
//				Transform temp_transform = go.transform;
//				string path = "";
//				while(temp_transform != null)
//				{
//					path = "/" + temp_transform.name + path;
...
//		}
	...
	public void Notify3DTouchPress()
	{
		if( mCurrentSelection != null )
		{
			UICamera.Notify(mCurrentSelection, "On3DTouchPress", null);
		}
	}
