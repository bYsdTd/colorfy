...
public abstract class UIRect : MonoBehaviour
{
	...
	public class AnchorPoint
	{
		...
		public bool is_target_alive_ = false;
	...
	protected virtual void OnEnable ()
	{
		...
		leftAnchor.is_target_alive_ = leftAnchor.target != null;
		rightAnchor.is_target_alive_ = rightAnchor.target != null;
		topAnchor.is_target_alive_ = topAnchor.target != null;
		bottomAnchor.is_target_alive_ = bottomAnchor.target != null;
