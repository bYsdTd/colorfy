...
public class BMSymbol
{
	...
	public int advance	{ get { return mAdvance; } set { mAdvance = value; } }
...
#endif
		{
			...
			if (mSprite != null)
			{
				...
				else
				{
					...
					mWidth = (int)(mSprite.width * 1.5f);
					mHeight = (int)(mSprite.height * 1.5f);
					mAdvance = (int)(mSprite.width * 1.5f) + (mSprite.paddingLeft + mSprite.paddingRight);
					mIsValid = true;
				}
			}
		}
