	...
	static public void AddCommonItems (GameObject target)
	{
		if (target != null)
		{
			...
			if (Selection.activeTransform.parent != null && widget != null)
			{
				...
				AddChildWidget("Create/SymmetrySprite/Child", false, NGUISettings.AddSymmetrySprite);
				...
				AddSiblingWidget("Create/SymmetrySprite/Sibling", false, NGUISettings.AddSymmetrySprite);
			...
			else
			{
				...
				AddChildWidget("Create/SymmetrySprite", false, NGUISettings.AddSymmetrySprite);
